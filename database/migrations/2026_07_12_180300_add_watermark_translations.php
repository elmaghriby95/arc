...
return new class extends Migration
{
    ...
    private function entries(): array
    {
        return [
            ...
            ['group' => 'settings.watermark', 'key' => 'info', 'values' => ['ar' => 'تُطبَّق العلامة على نسخة مؤقتة فقط أثناء العملية. النسخة الأصلية المخزّنة تبقى كما هي. كل عملية تحصل على رقم تتبع UUID فريد يُسجَّل في سجل التدقيق.', 'en' => 'The watermark is applied only to a temporary copy. The stored original stays unchanged. Each action gets a unique UUID recorded in the audit trail.', 'fr' => 'Le filigrane s\'applique uniquement à une copie temporaire. L\'original reste inchangé.']],
