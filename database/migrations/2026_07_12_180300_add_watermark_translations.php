...
return new class extends Migration
{
    ...
    private function entries(): array
    {
        return [
            ...
            ['group' => 'settings.watermark', 'key' => 'info', 'values' => ['ar' => 'عند العرض تظهر علامة مائية لحظية فوق المعاينة ببيانات من فتح الملف الآن دون تعديل الأصل ودون إعادة بناء الملف. عند التحميل أو الطباعة تُدمَج العلامة داخل نسخة مؤقتة فقط. النسخة الأصلية المخزّنة تبقى كما هي. كل عملية تحصل على رقم تتبع UUID فريد.', 'en' => 'On view, a live overlay watermark shows the current opener’s data without modifying or rebuilding the stored file. On download or print, the watermark is burned into a temporary copy only. The stored original stays unchanged. Each action gets a unique UUID.', 'fr' => 'À l\'affichage, un filigrane live montre l\'utilisateur actuel sans modifier le fichier. Au téléchargement ou à l\'impression, le filigrane est intégré dans une copie temporaire.']],
