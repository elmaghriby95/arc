<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="settings-modules">
            ...
            <a href="{{ route('settings.general.index') }}" class="settings-module settings-module--general">
                ...
                <div class="settings-module-body">
                    <h3 class="settings-module-title">{{ __('settings.general_title') }}</h3>
                    <p class="settings-module-desc">{{ __('settings.general_desc') }}</p>
                    <div class="settings-module-meta">
                        <span class="settings-badge">{{ __('settings.general_badge') }}</span>
                    </div>
                </div>
            ...
            @permission('settings.database-clean')
            <a href="{{ route('settings.database-clean.index') }}" class="settings-module settings-module--db-clean">
                <div class="settings-module-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="settings-module-body">
                    <h3 class="settings-module-title">{{ __('settings.database_clean_title') }}</h3>
                    <p class="settings-module-desc">{{ __('settings.database_clean_desc') }}</p>
                    <div class="settings-module-meta">
                        <span class="settings-badge settings-badge--danger">{{ __('settings.database_clean_badge') }}</span>
                    </div>
                </div>
                <span class="settings-module-arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <div class="settings-modules">
            ...
            @permission('settings.watermark.view')
            <a href="{{ route('settings.watermark.index') }}" class="settings-module settings-module--watermark">
                <div class="settings-module-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                    </svg>
                ...
                <div class="settings-module-body">
                    <h3 class="settings-module-title">{{ __('settings.watermark_title') }}</h3>
                    <p class="settings-module-desc">{{ __('settings.watermark_desc') }}</p>
                    <div class="settings-module-meta">
                        <span class="settings-badge">{{ __('settings.watermark_badge') }}</span>
                    </div>
                </div>
                <span class="settings-module-arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
