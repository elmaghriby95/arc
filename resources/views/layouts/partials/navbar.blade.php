        ...
        <div class="navbar-start">
            ...
            <div class="navbar-menu" data-navbar-menu>
                ...
                @permission('transactions.view')
                    <a href="{{ route('transactions.index') }}" class="navbar-link {{ request()->routeIs('transactions.index', 'transactions.show', 'transactions.create', 'transactions.edit') ? 'is-active' : '' }}">
                        <span class="navbar-link-icon" aria-hidden="true">
                ...
                @permission('transactions.review-log.view')
                    ...
                    <a href="{{ route('transactions.review-log') }}" class="navbar-link {{ request()->routeIs('transactions.review-log') ? 'is-active' : '' }}">
                        <span class="navbar-link-icon" aria-hidden="true">
                        ...
                        <span class="navbar-link-text">{{ __('nav.review_log') }}</span>
                    </a>
                    @endif
                @endpermission
