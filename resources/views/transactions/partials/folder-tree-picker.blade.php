...
<div class="txnw-folder-picker" data-folder-picker>
    ...
    @if ($folders->isEmpty())
        <div class="txnw-alert txnw-alert--warn">
            لا توجد مجلدات. <a href="{{ route('settings.folders.index') }}">أنشئ مجلداً</a> أولاً.
        </div>
    @else
        <div class="txnw-search">
            ...
            <input type="search" class="txnw-input" placeholder="بحث..." data-folder-search autocomplete="off">
        </div>
